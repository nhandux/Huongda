 ...
 *
 */
(function(e){e.fn.extend({slimScroll:function(f){var a=e.extend({width:"auto",height:"250px",size:"3px",color:"#00579c",position:"right",distance:"1px",start:"top",opacity:.5,alwaysVisible:!1,disableFadeOut:!1,railVisible:!1,railColor:"#333",railOpacity:.2,railDraggable:!0,railClass:"slimScrollRail",barClass:"slimScrollBar",wrapperClass:"slimScrollDiv",allowPageScroll:!1,wheelStep:20,touchScrollStep:200,borderRadius:"8px",railBorderRadius:"8px"},f);this.each(function(){function v(d){if(r){d=d||window.event;

	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?=$act?>" method="post" enctype="multipart/form-data" name="member" id="memberUser">
					...
					<table class="table table-hover" style="width: 70%;">
						<tr>
							...
							<td><input class="form-control" type="text" name="user_name" id="user_name" <?=($typeFunc=='edit') ? "readonly" : "" ?> autocomplete="off" value="<?=stripslashes($user_name)?>" maxlength="16" ></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input class="form-control" type="text" name="full_name" id="full_name" value="<?=stripslashes($full_name)?>" autocomplete="off" maxlength="150" ></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input class="form-control" type="text" name="apply" id="apply" value="<?=stripslashes($apply)?>" autocomplete="off" maxlength="255"></td>
						</tr>
						<tr>
							<td><label>Email:</label></td>
							<td><input class="form-control" type="email" name="email" id="email" value="<?=stripslashes($email)?>" autocomplete="off" maxlength="200" ></td>
						</tr>
						<tr>
							<td><label>Số điện thoại:</label></td>
							<td><input class="form-control" type="text" name="phone" id="phone" value="<?=stripslashes($phone)?>" autocomplete="off" maxlength="20"></td>
						</tr>
						<tr>
							<td><label>Facebook:</label></td>
							<td><input class="form-control" type="text" name="address" id="address" value="<?=stripslashes($address)?>" autocomplete="off" maxlength="255"></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2">
								<textarea class="form-control" name="comment" id="comment"><?=stripslashes($comment)?></textarea>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<label class="radio-inline"><input type="radio" name="is_show" value="0" <?=$is_show==0?"checked":""?> > Đóng</label>
								<label class="radio-inline"><input type="radio" name="is_show" value="1" <?=$is_show==1?"checked":""?> > Mở</label>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2" align="center">
								...
								<button type="button" class="btn btn-form-info btn-form" onclick="location.href='?<?=TTH_PATH?>=core_user'">Thoát</button>
							</td>
						</tr>
					</table>
				</form>
				<script>
					<?=($typeFunc=='add') ? "window.onload=checkAddUser();" : "window.onload=checkEditUser();" ?>
				</script>
			</div>
		</div>
	</div>

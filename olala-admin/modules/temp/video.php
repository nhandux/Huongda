...
//
function video($act, $typeFunc, $gallery_id, $gallery_menu_id, $name, $title, $description, $keywords, $img, $link_youtube, $comment, $is_active, $hot, $created_time, $error) {
	global $db, $tth;
				...
				<form action="<?=$act?>" method="post" enctype="multipart/form-data">
					...
					<table class="table table-hover" style="width: 70%;">
						...
						<tr>
							...
							<td><input class="form-control" type="text" name="link_youtube" maxlength="255" value="<?=stripslashes($link_youtube)?>" required="required" ></td>
						</tr>
						<tr>

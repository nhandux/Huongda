	...
	<div class="form-group">
		...
		foreach($rows as $row) {
			...
			<div style="float: left; padding: 10px; border-left: 1px solid #ddd;">
				...
				<div class="checkbox" style="padding-left: 10px;">
					<label>
						<input type="checkbox" class="checkboxPro<?=$row['slug']?>" name="variable[]" <?=(in_array("product_menu_add;".$row['category_id'],$privilege)) ? "checked" : "" ?> value="product_menu_add;<?=$row['category_id']?>">Thêm mục
					</label>
				</div>
				<div class="checkbox" style="padding-left: 10px;">
					<label>
						<input type="checkbox" class="checkboxPro<?=$row['slug']?>" name="variable[]" <?=(in_array("product_menu_edit;".$row['category_id'],$privilege)) ? "checked" : "" ?> value="product_menu_edit;<?=$row['category_id']?>">Chỉnh sửa mục
					</label>
				</div>
				<div class="checkbox" style="padding-left: 10px;">
					<label>
						<input type="checkbox" class="checkboxPro<?=$row['slug']?>" name="variable[]" <?=(in_array("product_menu_del;".$row['category_id'],$privilege)) ? "checked" : "" ?> value="product_menu_del;<?=$row['category_id']?>">Xóa mục
					</label>
				</div>
				<div class="checkbox" style="padding-left: 20px;">
					<label>
						<input type="checkbox" class="checkboxPro<?=$row['slug']?>" name="variable[]" <?=(in_array("product_list;".$row['category_id'],$privilege)) ? "checked" : "" ?> value="product_list;<?=$row['category_id']?>">Danh sách tin rao
					</label>
				</div>
				<div class="checkbox" style="padding-left: 20px;">
					<label>
						<input type="checkbox" class="checkboxPro<?=$row['slug']?>" name="variable[]" <?=(in_array("product_add;".$row['category_id'],$privilege)) ? "checked" : "" ?> value="product_add;<?=$row['category_id']?>">Thêm tin rao mới
					</label>
				</div>
				<div class="checkbox" style="padding-left: 20px;">
					<label>
						<input type="checkbox" class="checkboxPro<?=$row['slug']?>" name="variable[]" <?=(in_array("product_edit;".$row['category_id'],$privilege)) ? "checked" : "" ?> value="product_edit;<?=$row['category_id']?>">Chỉnh sửa tin rao
					</label>
				</div>
				<div class="checkbox" style="padding-left: 20px;">
					<label>
						<input type="checkbox" class="checkboxPro<?=$row['slug']?>" name="variable[]" <?=(in_array("product_del;".$row['category_id'],$privilege)) ? "checked" : "" ?> value="product_del;<?=$row['category_id']?>">Xóa tin rao
					</label>
				</div>
				<div class="checkbox" style="padding-left: 20px;">
					<label>

...
<?php if(getConstant('author_google')!='') echo '<link rel="author" href="https://plus.google.com/' . getConstant('author_google') . '">'; ?>
...
<link rel="stylesheet" href="<?php echo HOME_URL; ?>/js/jquery.calendar/jquery.datetimepicker.css" type="text/css" media="all">
